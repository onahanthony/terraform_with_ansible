...
INSERT INTO characters (title, contents)
VALUES
('Aragorn', 'Descendant of Isildur who was a principal figure in both the Fellowship of the Ring and the War of the Ring.  Became king over the reunited kingdoms of Gondor and Arnor.'), ('Arwen', 'Daughter of Elrond Half-elven and Celebrían, marries Aragorn at the end of the War of the Ring and becomes queen of the reunited kingdoms of Gondor and Arnor.'), 
...
('Bard the Bowman', 'Man of Esgaroth who slayed Smaug the dragon.'), 
...
('Merry Brandybuck', 'A hobbit member of the Fellowship of the Ring and companion of Frodo Baggins. Assisted Éowyn in the slaying of the Witch-King of Angmar.'), 
...
('Denethor', 'Steward of Gondor during the events of the Lord of the Rings. Committed suicide during the Siege of Gondor.'), 
...
('Elrond', 'Ruler of the elven refuge of Rivendell. Son of the Half-elves Eärendil and Elwing, husband of Celebrian, father of Arwen, Elladan and Elrohir.'), 
...
('Finwë and Míriel', 'Parents of Fëanor and leaders of the Noldorin migrants to the Undying Lands. Míriel dies at childbirthwhile Finwë is slain by Morgoth.'), 
('Galadriel', 'Co-ruler of Lothlórien alongside her husband Celeborn. Relative of numerous notable characters in Tolkiens legendarium through bloodline and kinship.'), 
...
('Glorfindel', 'Noldorin elf-lord notable for his death and resurrection within Tolkiens legendarium.'), 
('Gimli', 'Dwarven member of the Fellowship of the Ring and a major character in The Lord of the Rings.'), 
('Goldberry', 'Mysterious entity known as the River-womans daughter, wife of Tom Bombadil.'), 
...
('Morgoth', 'The first Dark Lord in Tolkiens legendarium, originally known as Melkor. Succeeded by Sauron after his defeat and banishment by the Valar following the War of Wrath.'), 
...
('Tom Bombadil', 'A mysterious figure who aided the hobbits during their departure from the Shire in The Fellowship of the Ring.'), ('Pippin Took', 'A hobbit member of the Fellowship of the Ring and companion of Frodo Baggins. Served as a Guard of the Citadel of Minas Tirith during the War of the Ring.'), 
...
('Watcher in the Water', 'A mysterious aquatic creature who lives in a pool guarding the gates of Moria.');
